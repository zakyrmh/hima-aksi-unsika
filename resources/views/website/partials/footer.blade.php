<footer class="bg-white relative w-full bottom-0">
    <div class="container flex flex-col items-center justify-between p-6 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
        ...
        <div class="flex -mx-2">
            <a href="https://www.instagram.com/himaaksifeunsika/" target="_blank"
                class="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500" aria-label="Instagram">
