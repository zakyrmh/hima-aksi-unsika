...
@section('content')
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="{{ route('cabinets.update', ['cabinet' => $cabinet]) }}" method="POST"
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="title" name="title" type="text" autocomplete="title"
                        value="{{ old('title', $cabinet->title) }}" required
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="period" name="period" type="text" autocomplete="period"
                        value="{{ old('period', $cabinet->period) }}" required
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <textarea id="description" name="description" rows="4" autocomplete="description"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ old('description', $cabinet->description) }}</textarea>
                </div>
            </div>
                ...
                <div class="mt-2">
                    <div class="relative flex gap-x-3">
                        <div class="flex h-6 items-center">
                            <input id="status" name="status" type="checkbox" {{ $cabinet->status ? 'checked' : '' }}
            ...
            <div>
                ...
                <div class="flex items-center justify-center gap-x-2 w-full mt-2">
                    <img id="preview" class="w-32 h-32 rounded-md object-cover" src="{{ asset($cabinet->logo) }}"
                        alt="">
                    <label for="logo"
            ...
            <div>
                ...
                <div class="flex flex-col items-center justify-center gap-x-2 w-full mt-2">
                    <img id="preview2" class="h-32 rounded-lg aspect-[3/2] cover" src="{{ asset($cabinet->background) }}"
                        alt="">
